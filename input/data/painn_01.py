...
class StructureReader:
    ...
    def __call__(self, filename):
        ...
        if self.pkl:
            ...
            for i in range(nbrs_data[0]):
                ...
                if nn < self.max_num_nbrs:
                    ...
                    cutnumnbrs[3] += [[99999, 99999]] * (self.max_num_nbrs - nn)
            ...
            for i in range(len(structure)):
                ...
                if nn < self.max_num_nbrs:
                    ...
                    for k in range(self.max_num_nbrs - nn):
                        ...
                        cutnumnbrs[3].append([99999, 99999])
        ...
        structure_data['bonds'] = torch.tensor(cutnumnbrs[3], dtype=torch.float32)
...
class Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return fea  # {'num_atoms', 'atoms', 'atoms_embed', 'num_pairs', 'pairs', 'diff', 'distance', 'bonds', 'target'}
